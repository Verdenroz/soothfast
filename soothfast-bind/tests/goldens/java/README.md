...
- acme::counters: `Vec<Counter>` cannot cross into java: a sequence of `Counter` has no C spelling that owns its elements; a sequence of one primitive crosses as a pointer and a length
...
- acme::levels: `Vec<Level>` cannot cross into java: a sequence of `Level` has no C spelling that owns its elements; a sequence of one primitive crosses as a pointer and a length
