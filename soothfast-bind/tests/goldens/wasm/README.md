...
```js
import init, { Counter, Level, Mode, describe, describeOwned, digest, fail, findCounter, greet, isHigh, maybeRatio, mutateCounter, normalize, peakLevel, sampleIds, scaleInto, scaleOptional, setLevel, split, stamp, sumOptional, trim } from "./pkg/acme-core.js";
