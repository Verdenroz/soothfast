...
```js
import init, { Counter, Level, Mode, describe, describeOwned, digest, fail, findCounter, greet, maybeRatio, normalize, peakLevel, scaleInto, split, stamp, trim } from "./pkg/acme-core.js";
