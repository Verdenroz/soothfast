...
```js
import init, { Counter, Level, Mode, counters, describe, describeOwned, digest, fail, findCounter, greet, isHigh, levels, maybeRatio, mutateCounter, normalize, peakLevel, sampleIds, scaleInto, scaleOptional, setLevel, split, stamp, sumOptional, trim } from "./pkg/acme-core.js";
