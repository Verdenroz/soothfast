...
```js
import init, { Counter, Level, Mode, counters, describe, describeOwned, digest, fail, findCounter, greet, invertBits, isHigh, levels, maybeRatio, mutateCounter, normalize, peakLevel, sampleIds, scaleInto, scaleOptional, setLevel, split, stamp, sumOptional, trim, version } from "./pkg/acme-core.js";
