...
```js
import init, { Counter, Level, Mode, describe, describeOwned, digest, fail, findCounter, greet, isHigh, maybeRatio, mutateCounter, normalize, peakLevel, scaleInto, split, stamp, trim } from "./pkg/acme-core.js";
