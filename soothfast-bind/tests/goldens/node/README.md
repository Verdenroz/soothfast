...
```js
const { Counter, Level, Mode, counters, describe, describeOwned, digest, fail, findCounter, flags, greet, isHigh, levels, maybeRatio, mutateCounter, normalize, peakLevel, peek, sampleIds, scaleInto, scaleOptional, setLevel, split, stamp, sumOptional, trim } = require("acme-core");
```
