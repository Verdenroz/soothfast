...
impl Summary {
    ...
    fn deviations_into(&self, py: Python<'_>, values: BorrowedF64, mut out: BorrowedMutF64) -> PyResult<()> {
        ...
        let out = py.detach(|| self.0.deviations_into(values.as_slice(), out.as_mut_slice()));
        Ok(out)
    }
